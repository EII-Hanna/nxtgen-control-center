(() => {
  ...
  loadAsset('style','./commercial-dispatch-ui.css');
  ...
  loadAsset('style','./payment-automation.css');
  ...
  loadAsset('script','./commercial-dispatch-ui.js');
  ...
  loadAsset('script','./payment-automation.js');
